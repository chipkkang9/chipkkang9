...
<p>
  <img alt="AI Security" src="https://img.shields.io/badge/AI%20Security-111827?style=for-the-badge&logo=shield&logoColor=white">
  <img alt="VLM Safety" src="https://img.shields.io/badge/VLM%20Safety-4338ca?style=for-the-badge&logo=openai&logoColor=white">
  <img alt="Mechanistic Interpretability" src="https://img.shields.io/badge/Mechanistic%20Interpretability-0f766e?style=for-the-badge&logo=semanticweb&logoColor=white">
  <img alt="Audio Deepfake Defense" src="https://img.shields.io/badge/Audio%20Deepfake%20Defense-9f1239?style=for-the-badge&logo=audacity&logoColor=white">
</p>
...
```mermaid
flowchart LR
    A["Multimodal AI"] --> B["Safety failures"]
    B --> C["Behavior analysis"]
    C --> D["Activation steering"]
    D --> E["Safer response control"]

    F["Voice data"] --> G["Deepfake risk"]
    G --> H["Lightweight protection"]
    H --> I["User-side defense"]
```
